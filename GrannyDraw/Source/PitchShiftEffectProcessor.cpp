...
PitchShiftEffectProcessor::PitchShiftEffectProcessor(){
}
...
float PitchShiftEffectProcessor::processSample(float x, int channel)
{
...
void PitchShiftEffectProcessor::setFs(float Fs){
    this->Fs = Fs;
...
void PitchShiftEffectProcessor::setPitch(float semitone){
